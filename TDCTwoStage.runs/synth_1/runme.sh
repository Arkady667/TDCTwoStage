...
HD_PWD='/home/arkady/Documents/Vivado Projects/TDCTwoStage/TDCTwoStage.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UartModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UartModule.tcl
