...
HD_PWD='/home/arkady/Documents/Vivado Projects/TDCTwoStage/TDCTwoStage.runs/SynchVDL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SynchVDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SynchVDL.tcl
