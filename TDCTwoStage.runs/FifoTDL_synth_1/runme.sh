...
HD_PWD='/home/arkady/Documents/Vivado Projects/TDCTwoStage/TDCTwoStage.runs/FifoTDL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FifoTDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FifoTDL.tcl
